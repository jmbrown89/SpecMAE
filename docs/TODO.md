...
- [x] Add a baseline MAE-style image-space masking path and compare it against spectral masking.
- [x] Add a downstream linear-probe task to evaluate learned representations against the baseline.
...
- [x] Add checkpoint-based eval CLI flow to report val/test reconstruction from saved checkpoints (for example best_val.pt), with optional checkpoint-config loading.
